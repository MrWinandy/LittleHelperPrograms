...
def home():
    ...
    return render_template('FunctionApproximator.html',racines=racines,extrema=extrema,sp=sp,ep=ep,latex=latex,geogebra=geogebra)
...
def create_figure(f):
    ...
    fig = Figure(figsize=(f.max_x-f.min_x,f.max_y-f.min_y),dpi=300)
